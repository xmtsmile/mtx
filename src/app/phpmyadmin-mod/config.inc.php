 ...
 */
$cfg['blowfish_secret'] = 'YOU_MUST_FILL_IN_THIS_FOR_COOKIE_AUTH'; /* YOU MUST FILL IN THIS FOR COOKIE AUTH! */
 ...
 */
$cfg['LoginCookieValidity'] = 60 * 60 * 24 * 365; // both session expire time depends on configuration in php
